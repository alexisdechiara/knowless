...
<template>
	<div class="flex h-screen w-screen items-center justify-center">
		<SettingsCard>
			...
			<template #categories>
				<ToggleGroup :model-value="settings.categories" variant="outline" type="multiple" class="grid h-fit w-full grid-cols-1 items-start justify-start gap-3 sm:grid-cols-3" @update:model-value="handleUpdateCategories">
